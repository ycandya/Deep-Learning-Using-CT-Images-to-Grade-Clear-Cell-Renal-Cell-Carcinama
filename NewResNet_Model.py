...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.bn3 = nn.BatchNorm1d(128 * block.expansion)
        self.relu2 = Mish()
        self.fc2 = nn.Linear(128 * block.expansion, 64 * block.expansion)
        self.bn4 = nn.BatchNorm1d(64 * block.expansion)
        self.relu3 = Mish()
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    # modify
    model.fc1.apply(weight_init_kaiming)
    model.fc2.apply(weight_init_kaiming)
    model.fc3.apply(weight_init_kaiming)
    return model
